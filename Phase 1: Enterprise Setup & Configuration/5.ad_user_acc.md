...
> 📸 **Suggested Screenshot**: `img/tools_aduc.png` — showing where to find "Active Directory Users and Computers" in the Tools menu.
...
> 📸 **Suggested Screenshot**: `img/users_created.png` — showing both `john.doe` and `jane.doe` listed under the Users container.
...
> 📸 **Suggested Screenshot**: `img/vbox_snapshot_base.png` — showing the snapshot being taken and named `base`.
