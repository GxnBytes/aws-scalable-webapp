...
- At the sign-in screen, open your **virtual machine** → **settings** → **Network Adapter**

- Adjust the network configuration by slecting **Private to my Mac** as needed (e.g., this switchs it to a *Host-Only Adapter*).  
- Use the keyboard shortcut **Shift + F10** to open the Command Prompt inside the VM.  

## Step 2: Commands
- Enter the required setup commands.  
- The VM will restart automatically.  

## Step 3: Location and Network Setup
- Proceed through the location and setup screens.  
- When you reach the *Network Connection* page, choose the option to continue without internet.  
