...
1. Follow the ISO setup steps in [`general_installation.md`]([general_installation.md](https://github.com/Genvarelli/Threat-Detection-Monitoring-Lab/blob/main/Phase%201:%20Enterprise%20Setup%20&%20Configuration/1.general_installation.md)):
   - Start the VM
