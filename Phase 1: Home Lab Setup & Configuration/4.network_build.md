...
3. Modify Ethernet Adapter:
   ...
   ![Network Connections](img/networkconnections.png)
...
The **Server Manager** is the main interface you’ll interact with on Windows Server 2025. From here, you can add different roles and features to extend the functionality of the server.

### Instructions:

1. **Open Server Manager**:
    - Launch **Server Manager** (this is the main window for managing your server).
      
   ![Server Manager](img/servermanager.png)
   
3. **Add Roles and Features**:
    - Click **Add Roles and Features** to begin the installation process.

4. **Use Default Wizard**:
    - Go through the default configurations in the wizard and click **Next**.
      
   ![defaultwizardconfig](img/defaultwizardconfig.png)

5. **Role-Based Installation**:
    - Select **Role-based or feature-based installation** and click **Next**.

6. **Select Destination Server**:
    - In the **Select destination server** section, choose the default server (`10.0.0.5`) and click **Next**.

   ![defaultwizardconfig](img/defaultwizardconfig1.png)
...
8. **Install Active Directory Domain Services (AD DS)**:
   ...
   ![Active Directory Domain Services](img/installadds1.png)
   
10. **Install DHCP Server**:
    - Similarly, select **DHCP Server** and click **Add Features**.
    - Click **Next**.

    ![DHCP Server](img/dhcpserver.png)
    ![DHCP Server](img/dhcpserver1.png)
    
12. **Install DNS Server**:
    - Do the same for the **DNS Server** role: select it and click **Add Features**.
    - Click **Next**.
      
   ![DNS Server](img/dnsserver.png)
   
13. **Complete Installation**:
    - Continue clicking **Next** through all the default pages.
    - On the **Confirmation** page, click **Install** to begin the installation process.

      ![installation progress](img/installationprogress.png)

The server will now install the selected roles, extending its functionality to include AD DS, DHCP, and DNS.
